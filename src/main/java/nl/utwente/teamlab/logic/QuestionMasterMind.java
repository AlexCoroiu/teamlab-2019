...
public class QuestionMasterMind {

    //TODO more elaborate tag generation
    public ArrayList<String> generateTags(Question q){
        ArrayList<String> tags = q.getTags();
        if(!tags.contains(q.getComponent())){
            tags.add(q.getComponent());
        }
        return tags;
    }

    //TODO more elaborate scoring
    public int changeScore(Question q) {
        return q.getScore();
    }
}
